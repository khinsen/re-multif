\belowpdfbookmark{Abstract}{sec:abstract}
  ...
  % @TODO: link figures explicitly
  % Since figures are slightly out of order please provide a reference (or more explicitly label) which figures map to to which in the original implementation.
...
\section{Results}
  ...
  \subsection{Stochastic Simulations}
    ...
    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.73\textwidth,height=0.365\textwidth]{stochastic-switch}
