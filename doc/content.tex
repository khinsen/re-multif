...
\section{Results}
  ...
  \subsection{Frequency Divider}\label{sec:freq-div}
    ...
    \begin{figure}[!htbp]
      \centering
      \includegraphics[width=0.86\textwidth]{freqdiv-square}
  ...
  \subsection{Stochastic Simulations}
    ...
    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.70\textwidth,height=0.45\textwidth]{stochastic-switch}
    ...
    \begin{figure}[!htb]
      \centering
      \includegraphics[width=0.75\textwidth]{stochastic-oscillator}
