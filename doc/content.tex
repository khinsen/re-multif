...
\section{Results}
  ...
  \subsection{Bifurcation Analysis}
    ...
    % @TODO: no need to say `when` oscillations cease if they are shown
    \begin{figure}[!htbp]
      \centering
  ...
  \subsection{Toggle Switch}
    ...
    % @TODO: mention how the toggle switch works even from non-initial states (not shown in figures)
  ...
  \subsection{Stochastic Simulations}
    ...
    % @TODO: initial state is redundant here (it's the default)
    \begin{figure}[!htb]
      \centering
